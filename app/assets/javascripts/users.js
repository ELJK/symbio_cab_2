...
(function (jQuery) {
    ...
    function build(options) {
        ...
        function build() {
            ...
            els.each(function () {
                ...
                container.find(".ganttview-hzheader-day").popover({trigger: 'hover', html: true});
                container.find(".ganttview-hzheader-day-weekend").popover({trigger: 'hover', html: true});
                ...
                $(window).scroll(function(){
                    checkTodayAnimation(currentContainer, todayElement);
                });
    ...
    var Chart = function(div, opts) {
        ...
        function getDates(start, end) {
            ...
            dates[start.getFullYear()][start.getMonth()].unshift(start.clone().addDays(-1));
            dates[start.getFullYear()][start.getMonth()].unshift(start.clone().addDays(-2));
            dates[start.getFullYear()][start.getMonth()].unshift(start.clone().addDays(-3));
            dates[start.getFullYear()][start.getMonth()].unshift(start.clone().addDays(-4));
            dates[start.getFullYear()][start.getMonth()].unshift(start.clone().addDays(-5));
        ...
        function addBlocks(div, data, cellWidth, start) {
            ...
            for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < data[i].series.length; j++) {
                    ...
                    var offset = DateUtils.daysBetween(start, series.start) + 5;
                    if (DateUtils.daysBetween(series.start, series.end) !== 0) {
...
// jquery.ganttView END
// ------------------------------------------------------


// jQuery Manipulations START
// ------------------------------------------------------



// jQuery Manipulations END
// ------------------------------------------------------
...
function isElementInViewport(elem) {
    ...
    var elemTop = Math.round( $elem.offset().top + $elem.height() );
    var elemBottom = elemTop + $elem.height();

    return ((elemTop < viewportBottom) && (elemBottom > viewportTop));
}

function checkTodayAnimation(elem, anelem) {
    //var $elem = $('.ganttview-slide-container');

    // If the animation has already been started
    if (elem.hasClass('animation-done')) return;

    if (isElementInViewport(elem)) {
        // Start the animation
        //$(document).ready(function () {
            elem.addClass('animation-done');
            elem.animate({scrollLeft: anelem.position().left-$(this).width()/4}, 'slow');
